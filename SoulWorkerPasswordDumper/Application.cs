...
internal static class Application
{
    ...
    internal static IEnumerable<IEnumerable<long>> GetGroupedOffsets(IEnumerable<IEnumerable<int>> addresses, Stream stream)
    {
    ...
    internal static async ValueTask<IEnumerable<IEnumerable<int>>> GetGroupedAddresses(string path)
    {
